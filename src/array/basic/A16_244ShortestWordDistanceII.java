 ...
 *
 */
public class A16_244ShortestWordDistanceII {

	HashMap<String, List<Integer>> map = new HashMap<>();

	public A16_244ShortestWordDistanceII(String[] words) {
	...
	public static void main(String[] args) {
		A16_244ShortestWordDistanceII a = new A16_244ShortestWordDistanceII(new String[] {"practice", "makes", "perfect", "coding", "makes"});
	}
}
